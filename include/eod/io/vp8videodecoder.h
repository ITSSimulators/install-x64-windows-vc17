...
*/
#ifndef SM_COREDATA_EOD_VP8VIDEODECODER_H
#define SM_COREDATA_EOD_VP8VIDEODECODER_H
...
namespace sm
{
    namespace eod
    {
        namespace io
        {
            class SM_COREDATA_API VP8VideoDecoder : public VP8VideoCodec<SerializableCompressorDecoder>
            {
            public:
                VP8VideoDecoder();
                ~VP8VideoDecoder();
...
#endif //SM_COREDATA_EOD_VP8VIDEODECODER_H
